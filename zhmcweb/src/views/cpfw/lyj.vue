...
let wordTemplate = ref({
    ...
    author: "刘沛",
    paragraph: [
        { type: "text", title: "一、冷应激程度预报", data: "" },
        { type: "text", title: "二、冷应激指数预报图" },
        { type: "chart", title: "冷应激指数预报图", xAxis: {}, series: {} },
    ]
});
...
`
    ...
    wordTemplate.value.paragraph[2].series = { "冷应激指数": [58, 69, 10, 41, 52, 33] }
